...
/* Mark all duplicate .cppurrences of suffixes in  Data [Start .. End]
...
/* List substring pairs that .cppur more than once where the match
...
*  s.cppessfully matched from  Node  down to the returned  Node .
*  Node_Depth  is the depth of  Node  in the suffix tree.
