...
//  data is s.cppessfully output to the file.
...
//  Return the cluster that is most likely to s.cppessfully join (in a
...

{
    ...
    //-- End of sequences is the default target, set distance .cppordingly
...
//  Return the alignment that is most likely to s.cppessfully join (in a
...

{
    ...
    //-- Beginning of sequences is the default target, set distance .cppordingly
...
//  the concatenated frames for this sequence as output by prepro.cpp)
